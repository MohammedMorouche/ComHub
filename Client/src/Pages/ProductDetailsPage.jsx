...
const SimilarProductCard = styled.div`
  ...
  &:hover {
    ...
    &:before {
      ...
      transform: translate(calc(var(--x, 50%) * -1), calc(var(--y, 50%) * -1))
...
const ProductDetailsPage = () => {
  ...
  const similarProducts = productData.filter(
    (product) =>
      product.category === selectedProduct?.category && product.id !== productId
  );
          ...
          {selectedProduct.promotion ? (
            <>
              <p
                ...
                className="Price"
              >
                Price: {selectedProduct.price} DA
              </p>
              <p style={{ fontWeight: "bold", color: "red" }} className="Price">
                Price: {selectedProduct.newprice} DA
              </p>
            </>
          ) : (
